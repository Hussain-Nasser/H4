...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto ">
      <img id="N" src="./img/N.jpeg" alt="">
      <h1 class="display-4 fw-normal">اربح مع حسين</h1>
      <p class="lead fw-normal">باقي على فتح التسجيل</p>
      <h3 color="red" id="countdown"></h3>
      <p class="lead fw-normal"> حساب نتفلكس لمدة شهر  </p>
    </div>
...
<div class="container">
  ...
  <li class="list-group-item">الرابح سيحصل على حساب نتفلكس لمدة شهر مجانا</li>
</ul>
</div>
</div>
